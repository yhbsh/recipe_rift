...
class AppConst {
  ...
  static const String recipesViewThumbnailUrl = 'https://images.unsplash.com/photo-1616169776580-c86189ee67b8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80';
  static final Tags tags = Tags.fromJson(jsonDecode(json));
}
...
class Tags {
  ...
  factory Tags.fromJson(Map<String, dynamic> json) {
    return Tags(
      ...
      items: (json['results'] as List<dynamic>).map((tagJson) => Tag.fromJson(tagJson)).toList(),
    );
  }
}
